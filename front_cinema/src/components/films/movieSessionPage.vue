    ...
    <div class="create_session-container">
      <div class="session_container">
        <div class="session-form">
          ...
          <div class="input-box-login">
            <button type="submit" class="button-create-session" @click="createSession" :disabled="isAnyFieldEmpty() || invalidDate || invalidPrice || invalidDiscount || invalidQuantityAvailablePlaces">
              <span>Create Session</span><i class="bx bx-arrow-back"></i>
            </button>
